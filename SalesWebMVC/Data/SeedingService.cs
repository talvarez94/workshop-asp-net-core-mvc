...
{
    public class SeedingService //Injeção de dependencia
    {
        ...
        public void Seed() //operação responsável por popular a base de dados (chama-se dentro do startup
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) //se ja existe algum dado na base de dados, interrompa a operação (Any do linq, testa se existe algum registro na tabela
            {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3400.0, d2);
            ...
            //mandar adc no bd pelo entity framework

            _context.Department.AddRange(d1, d2, d3, d4); //AddRange permite que coloque varios obj de uma vez
            ...
            _context.SaveChanges();//Salva e confirma alterações no banco de dados
